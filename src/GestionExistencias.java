...
public class GestionExistencias
{
    ...
    public GestionExistencias() 
    {
        ...
        Fondo fondo = new Fondo("imagenes/fondo.jpg");
        ...
        ImageIcon iconoOriginal = new ImageIcon("imagenes/info.png");
        ...
        try{
            ...
            Connection conexion = DriverManager.getConnection("jdbc:mysql://localhost/", usuarioMySQL, contraseñaMySQL);
            ...
            conexion = DriverManager.getConnection(msqls, usuarioMySQL, contraseñaMySQL);
            ...
            // Verificar si el usuario 'admin' existe MySQL
            String query = "SELECT * FROM Empleados WHERE usuario = 'admin'";
        ...
        // Verificar si el usuario 'admin' existe ObjectDB
        TypedQuery<Empleados> queryAdmin = em.createQuery("SELECT e FROM Empleados e WHERE e.usuario = 'admin'", Empleados.class);
        Empleados admin = null;
        try
        {
            admin = queryAdmin.getSingleResult();
        }
        catch (NoResultException ex) {}

        if (admin == null)
        {
            // Insertar al usuario admin con contraseña admin
            em.getTransaction().begin();
            Empleados adminNuevo = new Empleados();
            adminNuevo.setUsuario("admin");
            adminNuevo.setContraseña("admin");
            em.persist(adminNuevo);
...
//---------------------------------------- Ventana registrar o eliminar ----------------------------------------
        ...
        ventanaRegistrarEliminar.setResizable(false);
...
//---------------------------------------- Metodo registrar material ----------------------------------------
    private void manejadorRegistrarMaterial()
    {
        ...
        MaterialRegistrar materialRegistrar = new MaterialRegistrar(em, this, nrf, crf, ppurf, transObjectDBtoMySQL);
