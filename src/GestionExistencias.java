...
public class GestionExistencias
{
    ...
    private String usuarioMySQL = "root", contraseñaMySQL = "1";
    ...
    private final String txtfile="ZZ_Pruebas_Trabajo_Final/Materiales.txt";
    ...
    public GestionExistencias() 
    {
        ...
        Fondo fondo = new Fondo("ZZ_Pruebas_Trabajo_Final/imagenes/fondo.jpg");
        ...
        ImageIcon iconoOriginal = new ImageIcon("ZZ_Pruebas_Trabajo_Final/imagenes/info.png");
