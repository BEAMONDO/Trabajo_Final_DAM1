...
public class GestionExistencias
{
    ...
    private JButton rb, ab, bb, eb, editb, ncb, bhb, loginbmysql, loginbobjectdb, registrarbmysql, registrarbobjectdb, eliminarbobjectdb, eliminarbmysql ,BOTONPRUEBAS;
    private JTextArea hmf, etf, tetf;
...
//---------------------------------------- Ventana login ----------------------------------------
        ...
        loginbmysql = new JButton("Login MySQL");
        loginbmysql.setBounds(40, 100, 150, 25);
        loginPanel.add(loginbmysql);
        loginbobjectdb = new JButton("Login ObjectDB");
        loginbobjectdb.setBounds(200, 100, 150, 25);
        loginPanel.add(loginbobjectdb);
...
//---------------------------------------- Ventana registrar o eliminar ----------------------------------------
        ...
        registrarbmysql = new JButton("Registrar MySQL");
        registrarbmysql.setBounds(40, 110, 175, 25);
        registroPanel.add(registrarbmysql);
        registrarbobjectdb = new JButton("Registrar ObjectDB");
        registrarbobjectdb.setBounds(225, 110, 175, 25);
        registroPanel.add(registrarbobjectdb);
        eliminarbmysql = new JButton("Eliminar MySQL");
        eliminarbmysql.setBounds(40, 150, 175, 25);
        registroPanel.add(eliminarbmysql);
        eliminarbobjectdb = new JButton("Eliminar ObjectDB");
        eliminarbobjectdb.setBounds(225, 150, 175, 25);
        registroPanel.add(eliminarbobjectdb);

        /*JLabel tef = new JLabel("Empleados ObjectDB:");
        tef.setBounds(430, 20, 200, 25);
        registroPanel.add(tef);
        tetf = new JTextArea();
        tetf.setEditable(false);
        JScrollPane scrollPane3 = new JScrollPane(tetf);
        scrollPane3.setBounds(430, 50, 160, 140);
        registroPanel.add(scrollPane3);*/
        ...
        ventanaRegistrarEliminar.setSize(450 /*610*/, 260);
...
//---------------------------------------- Configuracion de botones ----------------------------------------
        ...
        loginbmysql.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
        ...
        loginbobjectdb.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
        ...
        registrarbobjectdb.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
        ...
        eliminarbobjectdb.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
        ...
        registrarbmysql.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
        ...
        eliminarbmysql.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
...
//---------------------------------------- Metodos extra ----------------------------------------
    ...
    public void actualizarTextoTETF() 
    {
        ...
        for (Empleados empleado : empleados) 
        {
            ...
            agregarTextoTETF(" Contraseña: " + empleado.contraseña);
            agregarTextoTETF("----------------------------------");
        }    
    }
