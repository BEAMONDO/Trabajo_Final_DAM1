...
public class GestionExistencias
{
    ...
    private JButton rb, ab, bb, eb, editb, ncb, bhb, eteb, loginbmysql, loginbobjectdb, BOTONPRUEBAS;
    private JTextArea hmf, etf;
    private JMenuItem ex, hi, ce, cs, tom, tmo, tot, tmt, tto, ttm, eao, emodo, eeo, eam, emodm, eem;
    private JComboBox<Materiales> naf, nbf, nef, neditf, nof;
    private JFrame ventana, ventanalogin;
...
//---------------------------------------- Desde aqui ----------------------------------------
        ...
        empleado.add(eao = new JMenuItem("Añadir empleado ObjectDB", 'A'));
        empleado.add(emodo = new JMenuItem("Modificar empleado ObjectDB", 'M'));
        empleado.add(eeo = new JMenuItem("Eliminar empleado ObjectDB", 'E'));
        empleado.addSeparator();
        empleado.add(eam = new JMenuItem("Añadir empleado MySQL", 'A'));
        empleado.add(emodm = new JMenuItem("Modificar empleado MySQL", 'M'));
        empleado.add(eem = new JMenuItem("Eliminar empleado MySQL", 'E'));
        //jmb.add(empleado);
        ...
        cs.addActionListener(new CopiaSeguridadMySQLMenu());
        ...
        //eao.addActionListener(new AñadirEmpleadoObjectDBMenu());
        //emodo.addActionListener(new ModificarEmpleadoObjectDBMenu());
        //eeo.addActionListener(new EliminarEmpleadoObjectDBMenu());
        //eam.addActionListener(new AñadirEmpleadoMySQLMenu());
        //emodm.addActionListener(new ModificarEmpleadoMySQLMenu());
        //eem.addActionListener(new EliminarEmpleadoMySQLMenu());
...
//---------------------------------------- Desde aqui ----------------------------------------
    ...
    class AñadirEmpleadoObjectDBMenu implements ActionListener
    {
        public void actionPerformed(ActionEvent e) 
        {
            if(e.getSource() instanceof JMenuItem) 
...
//---------------------------------------- Desde aqui ----------------------------------------
    ...
    class CopiaSeguridadMySQLMenu implements ActionListener 
    {
        public void actionPerformed(ActionEvent e) 
        {
            if(e.getSource() instanceof JMenuItem) 
